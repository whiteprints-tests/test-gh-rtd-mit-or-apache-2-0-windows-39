...
To report identified bugs, please fill a.[GitHub bug report issue](https://github.com/whiteprints-tests/test-gh-rtd-mit-or-apache-2-0-windows-39/issues/new?template=bug_report.yml).
...
To request features, please [open a discussion](https://github.com/whiteprints-tests/test-gh-rtd-mit-or-apache-2-0-windows-39/discussions/categories/ideas)

Once the enhancement has been discussed, fill a [GitHub feature issue](https://github.com/whiteprints-tests/test-gh-rtd-mit-or-apache-2-0-windows-39/issues/new?template=feature_request.yml).
...
[Pull Request]: https://github.com/whiteprints-tests/test-gh-rtd-mit-or-apache-2-0-windows-39/pulls
[issue]: https://github.com/whiteprints-tests/test-gh-rtd-mit-or-apache-2-0-windows-39/issues
